...
config :diary, DiaryWeb.Endpoint, http: [port: String.to_integer(System.get_env("PORT", "4000"))]
  ...
  config :diary, DiaryWeb.Endpoint,
    live_reload: [
      ...
      patterns: [
        ...
        ~r"lib/diary_web/router\.ex$"E,
        ~r"lib/diary_web/(controllers|live|components)/.*\.(ex|heex)$"E
      ]
    ]
end
