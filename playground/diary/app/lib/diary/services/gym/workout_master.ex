defmodule Diary.WorkoutMaster do
  ...
  def dummy_translations do
    ...
    gettext("ベンチプレス")
    gettext("インクラインベンチプレス")
    gettext("デクラインベンチプレス")
    gettext("ダンベルベンチプレス")
    gettext("インクラインダンベルプレス")
    gettext("デクラインダンベルプレス")
    gettext("チェストプレス（マシン）")
    gettext("スミスマシンベンチプレス")
    gettext("ダンベルフライ")
    gettext("インクラインダンベルフライ")
    gettext("ケーブルフライ")
    gettext("ロー・トゥ・ハイ ケーブルフライ")
    gettext("ハイ・トゥ・ロー ケーブルフライ")
    gettext("ペックデック（マシンフライ）")
    gettext("ディップス（胸狙い）")
    gettext("プッシュアップ")
    gettext("ウェイトプッシュアップ")
    gettext("スヴェンプレス（プレートスクイーズプレス）")
    # Back Exercises
    gettext("デッドリフト")
    gettext("ラックプル")
    gettext("懸垂（プルアップ）")
    gettext("ラットプルダウン")
    gettext("ストレートアームプルダウン")
    gettext("バーベルロー")
    gettext("ペンドレイロー")
    gettext("Tバーロー")
    gettext("ダンベルロー（ワンハンドロー）")
    gettext("シーテッドケーブルロー")
    gettext("チェストサポートロー")
    gettext("マシンロー")
    gettext("インバーテッドロー")
    ...
    gettext("スミスマシンロー")
    gettext("メドウズロー")
    gettext("ケーブルロー（ワイドグリップ）")
    gettext("ケーブルロー（ナローグリップ）")
    gettext("リアデルトロー（背中・後肩狙い）")
    gettext("ショルダープレス")
    gettext("バーベルショルダープレス")
    gettext("ダンベルショルダープレス")
    gettext("サイドレイズ")
    gettext("ケーブルサイドレイズ")
    gettext("リアレイズ")
    gettext("フェイスプル")
